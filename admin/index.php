  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a onclick="information()" href="#"><i class="fa fa-pencil"></i> <span>Information</span></a></li>
        <li><a onclick="users()" href="#"><i class="fa fa-users"></i> <span>Users</span></a></li>
        <li><a onclick="subject()" href="#"><i class="fa fa-book"></i> <span>Subject</span></a></li>
	    </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
