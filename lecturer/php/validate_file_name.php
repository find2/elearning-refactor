<?php
    ...
    $file_target = "../../assignment/" . $class_name . "_" . $monarch . "/question/" . $new_file_name;
    
    //$result=$object->Validate_Assignment_Number($assignment_number, $class_id, $user_id);
    ...
    if(strtolower($file_type) != "pdf" && strtolower($file_type) != "doc" && strtolower($file_type) != "docx"){
        ...
        if(file_exists($file_target)){
            ...
            //}
        	//else{
        	  //  $data='2'; // Already create assignment
        	//}
        }
    }
