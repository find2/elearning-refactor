...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a onclick="back_home()" href="#"><i class="fa fa-home"></i> <span>Home</span></a></li>
        ...
        <li><a onclick="learning_source()" href="#"><i class="fa fa-folder-o"></i><span>Learning Sources</span></a></li>
				<li><a onclick="assignment()" href="#"><i class="fa fa-files-o"></i><span>Assignment</span></a></li>
				<li><a onclick="quiz()" href="#"><i class="fa fa-superscript"></i><span>Quiz</span></a></li>
	    </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <input type="hidden" id="g_class_id" value="<?php echo end(explode("_", $_GET['cid'])); ?>">
    <input type="hidden" id="g_class_name" value="<?php echo $_GET['cid']; ?>">
  </div>
  <!-- /.content-wrapper -->
