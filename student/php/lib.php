	...
	public function Show_Quiz_Question($attempt, $quiz_id, $quiz_name){
        ...
        if(count($essay_quiz)>0){
          $data_code.='<h4>Essay</h4>';
            ...
            <label for="answer_essay_'. $essay['question_number_essay'] .'">Answer: </label>
            <input type="text" id="answer_essay_'. $essay['question_number_essay'] .'" name="answer_essay_'. $essay['question_number_essay'] .'">';
            $total_essay++;
        	}
        }// End Essay
